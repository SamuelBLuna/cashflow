...
{
    private const int HEIGTH_ROW_EXPENSE_TABLE = 25;
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        foreach(var expense in expenses)
        {
            ...
            row.Height = HEIGTH_ROW_EXPENSE_TABLE;
            ...
            if(!string.IsNullOrWhiteSpace(expense.Description))
            {
                ...
                descriptionRow.Height = HEIGTH_ROW_EXPENSE_TABLE;

                descriptionRow.Cells[0].AddParagraph(expense.Description);
                descriptionRow.Cells[0].Format.Font = new Font { Name = FontHelper.RALEWAY_REGULAR, Size = 10, Color = ColorsHelper.BLACK };
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Title = $"{ResourcePaymentGenerationType.EXPENSE_FOR} {month:Y}";
        document.Info.Author = "Samuel Luna";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "Logo", "i32.png");

        row.Cells[0].AddImage(pathFile);
        row.Cells[1].AddParagraph("Hey, Samuel Luna");
    ...
    private void CreateTotalSpentSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        var title = string.Format(ResourcePaymentGenerationType.TOTAL_SPENT_IN, month.ToString("Y"));
    ...
    private void AddExpenseTitle(Cell cell, string expenseTitle)
    {
        ...
        cell.Shading.Color = ColorsHelper.RED_LIGH;
    ...
    {
        cell.Format.Font = new Font { Name = FontHelper.WORKSANS_REGULAR, Size = 11, Color = ColorsHelper.BLACK };
    ...
    private void AddAmountForExpense(Cell cell, decimal amount)
    {
        ...
        cell.Format.Font = new Font { Name = FontHelper.WORKSANS_REGULAR, Size = 13, Color = ColorsHelper.BLACK };
